// src/lib.rs
/*
 * Core library for HyperSpectral
 */
...
#[derive(Debug)]
pub struct HyperSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperSpectral processing");
    
    let mut processor = HyperSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperSpectralProcessor::new(false);
